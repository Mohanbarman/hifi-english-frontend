...
class VideoScreen extends React.Component {
  constructor(props) {
    let { remoteUser } = this.context;
    console.log(remoteUser.id, 'text');
    super(props);

    this._session = null;
    this.opponentsIds = [remoteUser.id];

    this.state = {
      localStream: null,
      remoteStreams: [],
      selectedUsersIds: [remoteUser.id],
      isActiveSelect: true,
      isActiveCall: true,
...
VideoScreen.contextType = AuthContext;
